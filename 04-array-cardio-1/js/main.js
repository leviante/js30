...
const fullNames = inventors.map(inventor => {
  //return { first: inventor.first, last: inventor.last }; to return object
...
const birthDateSort = inventors.sort((a, b) => {
...
const totalYears = inventors.reduce(function(totalYear, inventor) {
